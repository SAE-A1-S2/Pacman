...
namespace Engine
{
    public class Winston : Enemy
    {
        private int startX, endX, startY, endY;
        public Winston(CellCoordinates startPosition, Cell[,] maze) : base(startPosition, maze)
        {
            CalculateZoneBounds();
        ...
        protected override bool IsPositionValid(CellCoordinates newPosition)
        {
